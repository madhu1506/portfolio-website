...
import {BiMessage, BiMenuAltRight} from 'react-icons/bi'
    ...
    <nav className='navbar'>
        ...
        <button className='desktopMenuBtn' onClick={()=>{
          document.getElementById('contact').scrollIntoView({behaviour:'smooth'});
            ...
            <BiMessage className='desktopMenuImg' />Contact Me
        </button>
        ...
        <div className='navMenu' style={{display:showMenu? 'flex':'none'}}>
            ...
            <Link activeClass='active' to='works' spy={true} smooth={true} offset={-50} duration={500} className='listItem'onClick={()=>setShowMenu(false)}>Work</Link>
